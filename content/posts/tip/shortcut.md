...
| #   | 단축키                   | 기능 요약             | 사용 포인트               |
| --- | --------------------- | ----------------- | -------------------- |
| 1   | `Ctrl + Z`            | Claude 백그라운드로 보내기 | 다른 터미널 작업 후 `fg`로 복귀 |
| 2   | `!`                   | Bash 모드 실행        | 간단한 터미널 명령 직접 실행     |
| 3   | `Ctrl + G`            | 멀티라인 편집           | 긴 프롬프트/Plan 중간 수정    |
| 4   | `Ctrl + S`            | 프롬프트 임시 저장(Stash) | 작업 전환 후 다시 복구        |
| 5   | `Esc + Esc`           | 코드·대화 롤백          | Git 없이 상태 되돌리기       |
| 6   | `Ctrl + W`            | 단어 단위 삭제          | 오타/파일명 빠른 수정         |
| 7   | `Ctrl + A / Ctrl + E` | 줄 처음/끝 이동         | 긴 입력 빠르게 편집          |
